...
namespace Booth.Scheduler.Test
{
    class WeeklyScheduleTemplateTests
    {
        ...
        public void FirstRunDateBeforeDate()
        {
            ...
            Assert.That(schedule.First(), Is.EqualTo(new DateTime(2019, 10, 23)));
        }
        ...
        public void FirstRunDateAfterDate()
        {
            ...
            Assert.That(schedule.First(), Is.EqualTo(new DateTime(2019, 10, 30)));
        }
        ...
        public void FirstRunDateBetweenDates()
        {
            ...
            Assert.That(schedule.First(), Is.EqualTo(new DateTime(2019, 10, 26)));
        }
        ...
        public void RunEveryFourWeeksOnWeekdays()
        {
            ...
            Assert.That(schedule.Take(10), Is.EqualTo(expected));
        }
    }
}
