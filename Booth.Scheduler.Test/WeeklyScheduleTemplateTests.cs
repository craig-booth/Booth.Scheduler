...
namespace Booth.Scheduler.Test
{
    class WeeklyScheduleTemplateTests
    {
        ...
        public void FirstRunDateBeforeDate()
        {
            ...
            Assert.That(dates.First(), Is.EqualTo(new DateTime(2019, 10, 23)));
        }
        ...
        public void FirstRunDateAfterDate()
        {
            ...
            Assert.That(dates.First(), Is.EqualTo(new DateTime(2019, 10, 30)));
        }
        ...
        public void FirstRunDateBetweenDates()
        {
            ...
            Assert.That(dates.First(), Is.EqualTo(new DateTime(2019, 10, 26)));
        }
        ...
        public void RunEveryFourWeeksOnWeekdays()
        {
            ...
            var dates = template.Schedule(startDate).Take(10);
