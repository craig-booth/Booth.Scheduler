...
namespace Booth.Scheduler.Test
{
    class FluentDailyTests
    {
        ...
        public void DailyAt14_30()
        {
            ...
            Assert.That(((ExactTimeScheduleTemplate)timeTemplate).Time, Is.EqualTo(new Time(14, 30, 00)));
        ...
        public void EveryFifthDayAt09_00()
        {
            ...
            var timeTemplate = schedule.TimeTemplate;
            Assert.That(timeTemplate, Is.AssignableTo(typeof(ExactTimeScheduleTemplate)));
            Assert.That(((ExactTimeScheduleTemplate)timeTemplate).Time, Is.EqualTo(new Time(09, 00, 00)));
        ...
        public void Every2DaysEveryMinuteFrom9To5()
        {
            ...
            Assert.That(((MinuteScheduleTemplate)timeTemplate).FromTime, Is.EqualTo(new Time(09, 00, 00)));
            Assert.That(((MinuteScheduleTemplate)timeTemplate).ToTime, Is.EqualTo(new Time(17, 00, 00)));
