    ...
    public class FluentDailyTests
    {
        ...
        public void DailyAt14_30()
        {
            ...
            using (new AssertionScope())
            {
                ...
                schedule.TimeTemplate.Should().BeOfType<ExactTimeScheduleTemplate>().And.BeEquivalentTo(new { Time = new Time(14, 30, 00) });
        ...
        public void EveryFifthDayAt09_00()
        {
            ...
            using (new AssertionScope())
            {
                ...
                schedule.TimeTemplate.Should().BeOfType<ExactTimeScheduleTemplate>().And.BeEquivalentTo(new { Time = new Time(09, 00, 00) });
        ...
        public void Every2DaysEveryMinuteFrom9To5()
        {
            ...
            using (new AssertionScope())
            {
                ...
                schedule.TimeTemplate.Should().BeOfType<MinuteScheduleTemplate>().And.BeEquivalentTo(new { Every = 1, FromTime = new Time(09, 00, 00), ToTime = new Time(17, 00, 00) });
        ...
        public void EveryDayEvery30MinutesFrom9To5()
        {
            ...
            {
                schedule.DateTemplate.Should().BeOfType<DailyScheduleTemplate>().And.BeEquivalentTo(new { Every = 1 });
                schedule.TimeTemplate.Should().BeOfType<MinuteScheduleTemplate>().And.BeEquivalentTo(new { Every = 30, FromTime = new Time(09, 00, 00), ToTime = new Time(17, 00, 00) });
